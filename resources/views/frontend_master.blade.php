...
<body>
			...
			<div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
				<div class="row">
					...
					{{-- <div class="col-lg-4 col-10">
						<a href="{{route('frontendloginpage')}}" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right"> Login | Sign-up </a> --}}
    ...
    <script type="text/javascript" src="{{asset('frontend_assets/js/shoppingcart.js')}}"></script>
    @yield('script')
